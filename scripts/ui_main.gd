...
func _on_btn_select_pressed():
	$Menu.visible = false
	var map_select = preload("res://scenes/ui_map_select.tscn").instantiate()
...
func _on_btn_editor_pressed():
	get_tree().change_scene_to_file("res://scenes/ui_editor.tscn")


# Settings
func _on_btn_settings_pressed():
	$Menu.visible = false
	var settings = preload("res://scenes/ui_settings.tscn").instantiate()
	add_child(settings)
	settings.tree_exited.connect(_on_settings_exit_settings)
	settings.saved.connect(_on_settings_saved)

func _on_settings_saved():
	var notice = preload("res://scenes/uic_notice.tscn").instantiate()
...
func _on_btn_about_pressed():
	$Menu.visible = false
	var about = preload("res://scenes/ui_about.tscn").instantiate()
	add_child(about)
...
func init_popup():
	warning_popup = preload("res://scenes/uic_pop_up.tscn").instantiate()
